...
function filterSelection(c) {
  ...
  if (c == "all") c = "";
  // tilføj "show" class (display:block) til filtrerede elementer, og fjern "show" class fra de elementer der ikke passer på filter
...
//skjul elementer der ikke bliver valgt
